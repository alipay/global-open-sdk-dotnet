...
public class AlipayApplyCardRequest : AMSRequest<AlipayApplyCardResponse>
    {
        ...
        public AlipayApplyCardRequest( string requestId , string cardNickName , string cardBinRule , string purpose , Dictionary<string, string> metadata , AuthorizationControl authorizationControl)
        {
