...
public class MerchantInfo
    {
        ...
        public MerchantInfo( string referenceMerchantId , string loginId , LegalEntityType legalEntityType , Company company , BusinessInfo businessInfo , EntityAssociations[] entityAssociations)
        {
