...
public class Quote
    {
        ...
        public Quote( string quoteId , string quoteCurrencyPair , decimal? quotePrice , string quoteStartTime , string quoteExpiryTime , bool? guaranteed , Amount exchangeAmount)
        {
