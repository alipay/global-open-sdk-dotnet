...
public class Env
    {
        ...
        public Env( TerminalType terminalType , OsType osType , string userAgent , string deviceTokenId , string clientIp , string cookieId , string extendInfo , string storeTerminalId , string storeTerminalRequestTime , BrowserInfo browserInfo , string colorDepth , string screenHeight , string screenWidth , int? timeZoneOffset , string deviceBrand , string deviceModel , string deviceLanguage , string deviceId , string osVersion)
        {
