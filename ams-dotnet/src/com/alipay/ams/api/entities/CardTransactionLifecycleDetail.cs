...
public class CardTransactionLifecycleDetail
    {

        public CardTransactionLifecycleDetail() { }

        

        public CardTransactionLifecycleDetail( string lifecycleId , string latestEventType , string latestEventStatus , string lastUpdateTime , string transactionTime , Amount totalBillingAmount , Amount totalAuthAmount , Amount totalCancelAmount , Amount totalRefundAmount , Amount totalChargebackAmount , string assetId , string maskedCardNo , List<CardTransactionEvent> events)
        {
