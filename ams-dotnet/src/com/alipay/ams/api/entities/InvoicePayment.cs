...
public class InvoicePayment
    {
        ...
        public InvoicePayment( string invoicePaymentId , int? attemptNo , string paymentRequestId , string paymentId , string payToRequestId , string payToId , Amount paymentAmount , string paymentOrderStatus , string paymentMethod , string errorCode , string errorMessage , string retryReason , string paymentTime , string nextRetryAt , string gmtCreate , string gmtUpdate)
        {
