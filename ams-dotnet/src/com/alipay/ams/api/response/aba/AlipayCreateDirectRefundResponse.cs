...
public class AlipayCreateDirectRefundResponse : AMSResponse
    {

        public AlipayCreateDirectRefundResponse() { }

        

        public AlipayCreateDirectRefundResponse( string paymentId , string refundId , string refundRequestId , string refundTime , RefundFromMethod refundFromMethod , Amount refundFromAmount , Amount refundToAmount , Result result)
        {
