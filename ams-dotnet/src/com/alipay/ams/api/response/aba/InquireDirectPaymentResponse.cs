...
public class InquireDirectPaymentResponse : AMSResponse
    {

        public InquireDirectPaymentResponse() { }

        

        public InquireDirectPaymentResponse( TransactionStatusType paymentStatus , string paymentResultMessage , string paymentResultCode , string paymentId , string paymentRequestId , PaymentMethod payToMethod , Amount paymentAmount , Amount payToAmount , string paymentTime , Result result)
        {
