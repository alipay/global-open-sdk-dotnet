...
public class AlipayInquireDirectPaymentResponse : AMSResponse
    {

        public AlipayInquireDirectPaymentResponse() { }

        

        public AlipayInquireDirectPaymentResponse( TransactionStatusType paymentStatus , string paymentResultMessage , string paymentResultCode , string paymentId , string paymentRequestId , PaymentMethod payToMethod , Amount paymentAmount , Amount payToAmount , string paymentTime , Result result)
        {
