...
public class InquireDirectRefundResponse : AMSResponse
    {

        public InquireDirectRefundResponse() { }

        

        public InquireDirectRefundResponse( TransactionStatusType refundStatus , string refundResultMessage , string refundResultCode , string refundId , string paymentId , string refundRequestId , string refundTime , RefundFromMethod refundFromMethod , Amount refundToAmount , Amount refundFromAmount , Result result)
        {
