...
def replace_once(relative_path, pattern, replacement, flags=0):
...
replace_once(
    ...
    r"(<PackageId>global-open-sdk-dotnet</PackageId>\s*<Version>)[^<]+(</Version>)",
...
echo "Updated global-open-sdk-dotnet to $VERSION"
